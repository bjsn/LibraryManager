namespace RFP.Views
{
    ...
    public class RFP_Editor : BasePartialView
    {
        ...
        public RFP_Editor(Panel Panel, BasePartialView Preview = null)
            : base(Panel, Preview)
        {
            this.previewKeyEnter = new KeyEventArgs(Keys.Back);
            this.InitializeComponent();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.RFPController == null)
            {
                this.RFPController = new RFPController();
            }
            this.RTFString = EditorBox.Rtf;
            this.RFPController.UpdateRFTById(this.RTFId, this.RTFName, this.RTFString);
            base.ClosePartialView();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.EditorControl_Bullet.Image = global::RFPView.Properties.Resources.bullets;
            ...
            this.label6.Text = "RFPContent > Editor";
            // 
            // RFP_Editor
            // 
        ...
        public void SetRTFId(int id)
        {
            this.RTFId = id;
        }

        public void SetRTFName(string name)
        {
            this.Name = name;
        }
